// src\forms\lib\base_dropdown.js
...
*/
class BaseDropdown extends LitElement {
  ...
  async queryDropdownData(query) {
    ...
    await this.initPromise;  // 等待模块加载完成
    const results = await this.dbModule.queryStartsWith(this.fieldName, query, this.queryLimit);
