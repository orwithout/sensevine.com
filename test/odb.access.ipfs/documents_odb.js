...
import { createOrbitDB , Documents, Identities, KeyStore, IPFSAccessController } from '@orbitdb/core';
...
class DocumentStore {
  ...
  async init() {
    ...
    this.orbitdb = await createOrbitDB({ipfs: this.helia,  directory: '/my_odb', id:'userA'});
